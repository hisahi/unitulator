...
export enum UnitulatorMode {
  Difference, Additive, Absolute, Logarithm, Percent, Help
}
...
export const changeMode = (newMode: UnitulatorMode): Action<string, UnitulatorMode> =>
  ({ type: MODE_CHANGE, payload: newMode });
